...
import com.zevaguillo.infrastructure.persistence.entity.CuentaEntity;
import com.zevaguillo.infrastructure.persistence.entity.CuentaRepository;
...
public class CuentaJpaAdapter implements CuentaPersistencePort {
    ...
    public Cuenta save(Cuenta cuenta) {
        try {
            ...
            throw new ActualizacionConcurrenteCuentaException(
                    "La cuenta fue actualizada por otra transaccion. Reintente la operacion.",
                    ex
            );
        }
    }
