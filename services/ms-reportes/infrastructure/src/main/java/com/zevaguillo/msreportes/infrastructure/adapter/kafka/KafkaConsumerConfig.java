package com.zevaguillo.msreportes.infrastructure.adapter.kafka;

import com.zevaguillo.msreportes.infrastructure.handler.ClienteEventHandler;
import com.zevaguillo.msreportes.infrastructure.handler.CuentaEventHandler;
import com.zevaguillo.msreportes.infrastructure.handler.MovimientoEventHandler;
...
public class KafkaConsumerConfig {
    ...
    @KafkaListener(topics = "cuenta-events", groupId = "ms-reportes-group")
    ...
    @KafkaListener(topics = "movimiento-events", groupId = "ms-reportes-group")
