...
public interface ReporteMovimientoRepository extends JpaRepository<ReporteMovimientoEntity, UUID> {
    Page<ReporteMovimientoEntity> findByClienteIdAndFechaBetweenOrderByFechaDesc(UUID clienteId, LocalDateTime fechaInicio, LocalDateTime fechaFin, Pageable pageable);
}